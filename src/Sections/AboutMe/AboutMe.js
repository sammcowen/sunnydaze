...
const AboutMe = () => {
 ...
 <img src={Me} alt="samm cowen"/>
       ...
       <span>I am</span> Samm </h2>
        <p class ='sectionHeader'> <span>Full Stack </span>  Web Developer . B.A. in <span> Communications.</span>I love making <span>magic</span> with my code to create <span>useful</span>  and <span>visually pleasing</span> websites.<br/>
