      ...
      <div className='row row-cols-3 row-cols-md-3 g-4 works'>
        ...
        <div className='col'>
          <div className="card card-deck" style={{ width: '18rem' }}>
            ...
            <h6 className="card-subtitle mb-2 text-muted">Handlebars / Express /Node / SQL </h6>
        ...
        <div className='col'>
          <div className="card card-deck" style={{ width: '18rem' }}>
            ...
            <h6 className="card-subtitle mb-2 text-muted">HTML / JS / CSS / API</h6>
        ...
        <div className='col'>
          <div className="card card-deck" style={{ width: '18rem' }}>
            ...
            <h6 className="card-subtitle mb-2 text-muted">HTML/ CSS/ Jquery / API</h6>
